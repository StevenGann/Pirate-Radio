...
async def test_nulldj_returns_empty_for_any_kind() -> None:
    ...
    assert await NullDJ().patter(_ctx()) == ""  # accepts a real DjContext
...
async def test_scripteddj_returns_constant_text_for_any_kind() -> None:
    ...
    assert await dj.patter(_ctx()) == "hi there"
    assert await dj.patter(_ctx("station_id")) == "hi there"
...
async def test_scripteddj_per_kind_text_overrides_default() -> None:
    ...
    assert await dj.patter(_ctx()) == "intro line"
    assert await dj.patter(_ctx("outro")) == "default"  # unlisted kind -> default
...
async def test_scripteddj_default_text_is_empty() -> None:
    assert await ScriptedDJ().patter(_ctx()) == ""
